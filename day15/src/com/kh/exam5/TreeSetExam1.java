...
public class TreeSetExam1 {
  public static void main(String[] args) {
    ...
    System.out.println("87이거나 87보다 낮은 점수 : "+score);

    score = scores.ceiling(87);
    System.out.println("87이거나 87보다 높은 점수 : "+score);
...
//    SortedSet<Integer> integers2 = scores.subSet(80,false, 90,true);
    NavigableSet<Integer> integers2 = scores.subSet(80,false, 95,true);
    System.out.println(integers2);

    //오름차순하여 상위 그룸, 하위그릅 가져오기
